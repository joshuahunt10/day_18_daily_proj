...
/*************************************************************************************
------------ ANSWER -------------------
console.log(y) returns undefined and console.log(x) returns I'm a local variable.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) returns undefined.  The delcaration of x was hoisted but the assignment was not hoisted above the console.log.  console.log(foo) returns 'function hoisting' because the function is hoisted above the console.log.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
inside the IFEE add is 4 and outside the IFEE add is not defined.
**************************************************************************************/
...
//   "use strict";
//   var today = new Date();
//   var stringDate = today.toUTCString();
